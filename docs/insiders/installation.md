...
*mkdocstrings-typescript Insiders* is a compatible drop-in replacement for *mkdocstrings-typescript*,
...
Self-hosting the Insiders package makes it possible to depend on *mkdocstrings-typescript* normally,
...
>
> Now when running `pip install mkdocstrings-typescript`,
...
When upgrading Insiders, you should always check the version of *mkdocstrings-typescript*
