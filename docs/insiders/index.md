...
*mkdocstrings-typescript* follows the **sponsorware** release strategy, which means
...
*mkdocstrings-typescript Insiders* is a private fork of *mkdocstrings-typescript*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *mkdocstrings-typescript*.
...
*mkdocstrings-typescript* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *mkdocstrings-typescript*,
...
<small>
  ...
  your profile and avatar to show your support for *mkdocstrings-typescript*.
...
to use *mkdocstrings-typescript* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *mkdocstrings-typescript*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *mkdocstrings-typescript
Insiders* precisely under the same terms as *mkdocstrings-typescript*, which are given
